...
# move host files into the image.
# SPEC_RES_DIR="/home/amansoor/spec_run"
# sudo cp -r "${SPEC_RES_DIR}" $DIR/root/from_host
# sudo cp -r /home/amansoor/tlb-work/MyPinTool/run_505.mcf_r.sh $DIR/root/from_host
